...
// The createPokeCard function creates a new card (section element) and adds a new card to the webpage/document inside of the div with the id "container."
...
// The getPokemonData makes an axios get request to the pokeAPI using a specific Pokemon id/number. Then takes the returned data and passes it into the createPokeCard function.
